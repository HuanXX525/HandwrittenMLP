...
def forNotValue(fun):
    ...
    return wrapper
class Value():
    def __init__(self, data, child=(), _op="")->None:
        '''
        data:当前变量的数值
...
# ======== 加法运算 =======
    ...
    def __add__(self, other)-> "Value":
        out = Value(self.data + other.data, (self, other), _op="+")  # 必须包含两者
...
# ======== 指数运算和幂运算 =======
    ...
    def __pow__(self, other)-> "Value":
        ...
        out = Value(y, (self, other), _op="^")  # 之前是 (self,)，现在改为 (self, other)
...
# ======= max =======
    def max(self, other)-> "Value":
        ...
        out = Value(max(self.data, other.data), (self, other), _op="max")
...
# ======= log =======
    def log(self, numBase: float = math.e) -> "Value":
        ...
        out = Value(out_data, (self,), _op="log")
