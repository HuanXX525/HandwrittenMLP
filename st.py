from backward import ActivationFunction, LossFunction, SGD, to_one_hot, Layer, Value
import numpy as np
...
def simple_test():
    ...
    for epoch in range(num_epochs):
        ...
        for i in range(len(train_X)):
            ...
            # 计算损失
            loss = LossFunction.categorical_cross_entropy(y_hat, to_one_hot(train_y[i], output_size))
